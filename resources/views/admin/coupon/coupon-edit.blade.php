            ...
            <figure>
                ...
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.coupon.index')}}">Kuponlar</a></li>
                        <li class="breadcrumb-item">Kupon Güncelle</li>
                    </ol>
                </nav>
            </figure>
            <div class="row">
                <div class="col-12 col-lg-12 mt-3 ">
                    <form class="form-control" name="form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="code" placeholder="Kupon Kodu" value="{{$coupon->code}}">
                            <label for="floatingFirst">Kupon Kodu</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="discount" placeholder="İndirim Oranı" value="{{$coupon->discount}}">
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" name="end_date" placeholder="Bitiş Tarihi" value="{{$coupon->end_date}}">
