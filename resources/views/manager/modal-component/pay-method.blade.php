...
<div class="modal fade" id="paywire_transfer" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <label class="fw-bold">Ödenecek Tutar: </label>
                <div class="input-group mb-3 mt-3">
                    <input type="text" class="form-control" placeholder="Kupon kodu" aria-label="Kupon kodu"
                           aria-describedby="button-addon2">
                    <button class="btn btn-outline-success" type="button" id="button-addon2">Uygula</button>
                </div>
            </div>
